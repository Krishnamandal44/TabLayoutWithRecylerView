...
public class ElectronicsLoadFragment extends Fragment {
...
//        }
        final ArrayList<OnlineShoppingPojo> onlineShoppingPojos = OnlineShoppingElectronicsLoader.getInstance().getOnlineShoppingPojoList();
...
//                        }
//                        if (position == 1){ Intent productIntent = new Intent(getActivity(), OnlineShoppingProductDetailsVolley.class);
//                            productIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                            productIntent.putExtra("ProductId",onlineShoppingPojos.get(position).getId());
//                            startActivity(productIntent);
//                            //onClickProductDetails(view);
